...
{Все про CSS переходи (transitions) за 16 хвилин. Анімація CSS. Частина перша}  
...
## День ..... 10 (багато часу)
робив багато днів анімацію кавуна, огірка, лимона

## День 11
https://www.youtube.com/watch?v=Kwc9zfONzeM  
{Принципи дизайну ефектів (FX) в анімації}
 - Основи дизайну ефектів
- Шейпи/форми
- Об'ємна форма
- органічна
- Геометрична
...
- Колір
- Таймінг
- лімітований (3 кадри та більше)
- повний (1 кадр та 2 кадри)
- Реалістичний
- стилізований
- Фізика руху
- Реалізм
...
- Стилі (дуже умовно):
- Аніме
- Більш реалістичні елементи
- часто взаємодіють із оточенням
- велика деталізація
- лімітований таймінг або повний реалістичний
- Старий дісней
- Повний таймінг
- Більш реалістична анімація
- Досить детальний дизайн
- Картун
- Шейпи
- геометрична форма
- Все інше

Далі розбір сплесків води та перемальовування кадрів
